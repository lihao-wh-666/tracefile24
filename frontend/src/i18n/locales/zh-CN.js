export default {
  ...
  logArchives: {
    ...
    totalLogCount: '归档日志总数',
    timeRequired: '请选择时间范围',
    timeRangeInvalid: '结束时间必须大于开始时间',
    createSuccess: '归档任务已创建',
    createFailed: '创建归档任务失败',
    autoArchiveTriggered: '自动归档已触发',
    autoArchiveFailed: '触发自动归档失败',
    downloadFailed: '下载归档文件失败',
    deleteConfirm: '确定要删除此归档记录及其文件吗？此操作不可恢复。'
  }
}
